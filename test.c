...
void test_questionMarkControl() {
    const char *TEXT = "color, colour, test";
...
void test_upperCaseControl() {
    const char *TEXT = "Uppercase, test";
...
void test_dividerControl() {
    const char *TEXT = "gray, grey, test";
...
void test_squareBracketsAndSlashControl() {
    const char *TEXT = "Go**le, go**le, test";
...
void test_squareBracketsAndHyphenAndDividerControl() {
    const char *TEXT = "bat, cat, hat, mat, nat, oat, pat, Pat, ot, test";
...
void test_squareBracketsControl() {
    const char *TEXT = "babble, bebble, bibble, bobble, bubble, test";
...
void test_starControl() {
    const char *TEXT = "ggle, gogle, google, gooogle, goooogle, test";
...
void test_plusControl() {
    const char *TEXT = "gogle, google, gooogle, goooogle, test";
    const char *input = "go+gle";
...
void test_plusAndBracketsControl() {
    const char *TEXT = "google, googoogle, googoogoogle, googoogoogoogle, test";
...
void test_curlyBracketsAndSlash_d_Control() {
    const char *TEXT = "1axas7a1903, test";
...
int main() {
    ...
    test_questionMarkControl();
    test_exceptControl();
    test_upperCaseControl();
    test_dividerControl();
    test_dividerAndBracketsControl();
    test_squareBracketsAndSlashControl();
    test_squareBracketsAndHyphenAndDividerControl();
    test_squareBracketsAndHyphenControl();
    test_squareBracketsControl();
    test_starControl();
    test_plusControl();
    test_plusAndBracketsControl();
    test_curlyBracketsAndSlash_d_Control();
    test_curlyBracketsControl();
    test_slash_d_Control();
    test_dotControl();
    test_powerAndDollarControl();
    test_powerControl();
    test_dollarControl();
